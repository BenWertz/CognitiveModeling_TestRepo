...
MODEL_NAME = "hierarchical_no_swap_target_precision"
DISPLAY_NAME = "hierarchical_no_swap_target_precision"
STAN_FILE = ROOT / "models" / "hierarchical_no_swap_target_precision.stan"
...
data, lookup = make_stan_data(max_subjects=MAX_SUBJECTS)
